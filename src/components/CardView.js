...
const CardView = () => {
  ...
  return (
    <div className="flex-col ">
      <div className="">
      <button onClick={getNumberSignalementsByYear} className="px-10 py-2 text-sm font-bold text-gray-800 bg-[#FBFBFB] rounded-2xl hover:bg-green-500 hover:text-white m-2  ml-36 ">
        سنة
      </button>
      <button onClick={getNumberSignalementsByMonth} className="px-10 py-2 text-sm font-bold text-gray-800 bg-[#FBFBFB] rounded-2xl hover:bg-green-500 hover:text-white m-2">
        شهر
      </button>
      <button onClick={getNumberSignalementsByDay} className=" px-10 py-2 text-sm font-bold text-gray-800 bg-[#FBFBFB] rounded-2xl hover:bg-green-500 hover:text-white ml-2">
        يوم
      </button>
      </div>
      ...
      <div className="bg-[#FBFBFB] rounded-2xl m-1">
        ...
        <div className="bg-[#FBFBFB] rounded-2xl m-1 shadow-sm">
