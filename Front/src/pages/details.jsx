                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-4 p-4">
                    ...
                    <div className="md:basis-5/12 basis-full ">
                        ...
                        <div class="bg-gradient-to-t from-gray-100/60 to-white rounded-lg p-10 mt-3 shadow-lg">
                            {/* <p className="mb-4 text-lg flex-auto font-medium"><strong>التاريخ: </strong>  {isValidDate(signalement.date) ? new Date(signalement.date).toLocaleDateString() : ""}</p>
                             */}
                          <input
    className="mb-4 text-lg flex-auto font-medium"
    type="date"
...
/>
                            ...
                            <p className="mb-4 text-lg flex-auto font-medium"><strong>نوع الإخطار أو اسم الاخطار: </strong>  column not created in db</p>
